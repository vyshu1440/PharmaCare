    ...
    <div class="row" id="cards">
      <div class="col-sm-4">
        <div class="card border border-warning">
          <div class="card-body">
            <img src="images/Medicine.jpg" style="width:385.4px ; height:305px ;" class="d-block " alt="...">
      ...
      <div class="col-sm-4">
        <div class="card border border-warning">
          <div class="card-body">
            <img src="images/self-care1.jpg" style="width:385.4px ; height:305px ;" class="d-block " alt="...">
      ...
      <div class="col-sm-4">
        <div class="card border border-warning">
          <div class="card-body">
            ...
            <img src="images/machine1.jpg" style="width:385.4px ; height:305px ;" class="d-block " alt="...">
